...
AppPublisherURL=http://github.com/VadimRevich/Scripts/
AppSupportURL=http://github.com/VadimRevich/Scripts/
AppUpdatesURL=http://github.com/VadimRevich/Scripts/
AppSupportPhone=+79173171027
UninstallFilesDir={win}
VersionInfoVersion=1.0.0.0
VersionInfoCompany=New Internet Technologies Inc.
VersionInfoCopyright=(C) 2015-2019 VadimRevich
